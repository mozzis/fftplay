...
/* Generated on Fri Jan 27 19:31:37 EST 2006 */
 ...
 * 212 stack variables, and 128 memory accesses
 */
/*
 * Generator Id's : 
...
static const R *t2_32(R *ri, R *ii, const R *W, stride ios, INT m, INT dist)
{
     ...
     for (i = m; i > 0; i = i - 1, ri = ri + dist, ii = ii + dist, W = W + 8, MAKE_VOLATILE_STRIDE(ios)) {
	  E T9A, T9z;
	  {
	       ...
	       {
		    E T31, T34, T2X, T46, Tq, T97, T8H, T8D, T4b, T98, TH, T7f, TZ, T4j, T6t;
		    E T1g, T7g, T6u, T4q, T4z, T6x, T1J, T7m, T6y, T4G, T7l, T8d, T6B, T4V, T7r;
		    E T8e, T4O, T6A, T2k, T7o, T5E, T6P, T3G, T7L, T61, T6M, T7I, T8n, T55, T6I;
		    E T2N, T7A, T5s, T6F, T7x, T8i, T62, T5L, T7J, T43, T63, T5S, T8o, T7O, T57;
		    E T2R, T2U, T3a, T35, T5h, T58, T2Z, T32;
		    {
			 E T2F, T1V, T1K, T2T, T2w, T2J, T1N, T2c, T2s, T2g, T1Z, T3n, T3f, T3z, T3j;
			 E T3C, T3r, T3Q, T3M, T1x, T4E, T1H, T7j, T4x, T4A, T1v, T1B, T4B;
			 {
			      E TA, T1F, T15, TE, T1s, T11, T1C, TW, TS, T1o, TF, Ty, T49, TC, T48;
			      {
				   E T1, T8G, Tk, Tn, Tj, To;
				   T1 = ri[0];
				   T8G = ii[0];
				   Tk = ri[WS(ios, 16)];
				   T2F = FNMS(Tg, Td, T2E);
				   ...
				   To = ii[WS(ios, 16)];
				   {
					E Tx, T47, Tu, Tp, T8F, TB, Tt, Tl, T8E;
					Tx = ii[WS(ios, 8)];
					Tt = ri[WS(ios, 8)];
					Tl = Tj * Tk;
					T8E = Tj * To;
			      ...
			      }
			      {
				   ...
				   T4f = FNMS(TM, TK, T4e);
				   {
					E T17, T4m, T1a, T1e, T1b, T4n;
					{
					     E T4h, TY, T4i, T4d;
					     {
						  E T12, T16, T4g, TU, T13, T4l;
						  T12 = ri[WS(ios, 28)];
						  T16 = ii[WS(ios, 28)];
						  T4g = TW * TT;
						  TU = TS * TT;
			 ...
			 }
			 {
			      ...
			      {
				   E T1P, T4J, T2i, T27, T4T, T24, T4L, T21;
				   {
					E T1L, T2d, T4I, T2e, T2h;
					{
					     E T1M, T4F, T7k, T1O, T1I, T4y, T4C;
					     T1L = ri[WS(ios, 30)];
					     T1I = T1B + T1H;
					     T4y = T1B - T1H;
				   ...
				   {
					E T3l, T5z, T5B, T3t, T3w, T3x, T3D, T3A;
					{
					     E T3g, T5y, T3h, T3k;
					     {
						  E T4M, T7p, T4P, T22, T4R, T28, T4Q, T25;
						  T3g = ri[WS(ios, 31)];
						  T4Q = T26 * T24;
						  T25 = T23 * T24;
						  T4M = T4J - T4L;
			      ...
			      {
				   E T2q, T50, T2L, T2A, T5q, T2B, T52, T2y, T2C;
				   {
					E T2n, T2G, T4Z, T2H, T2K;
					{
					     E T2o, T7H, T60, T2p, T3F, T5D, T5X;
					     T2n = ri[WS(ios, 1)];
					     T3F = T3y + T3E;
					     T5D = T3y - T3E;
					     T5X = FNMS(TR, T3v, T5W);
				   ...
				   {
					E T3U, T5Q, T41, T3T, T5K, T5J, T7M, T3X, T5N;
					{
					     E T3K, T5G, T3S, T5I, T3V, T3W;
					     {
						  E T40, T3Y, T3N, T3R;
						  {
						       E T7v, T5m, T7w, T5r;
						       {
							    E T3H, T53, T2z, T3I, T3J, T2M, T54, T5o, T5F, T2D, T5n;
							    T3H = ri[WS(ios, 3)];
							    T7v = T50 + T52;
							    T53 = T50 - T52;
							    T2z = T2q + T2y;
					...
					{
					     E T37, T38, T39, T5g, T2Y, T2V;
					     {
						  E T2Q, T5M, T5R, T7N, T2O, T42, T5O, T56, T2P;
						  T2Q = ii[WS(ios, 5)];
						  T42 = T3X + T41;
						  T5M = T3X - T41;
						  T5O = FNMS(Tg, T3U, T5N);
		    ...
		    {
			 E T5t, T5c, T5j, T5u, T88, T90, T8Z, T8b;
			 {
			      E T7e, T8T, T7D, T7y, T7h, T8U, T8S, T8R;
			      {
				   ...
				   E T8k, T8p, T8w, T2m;
				   {
					...
					{
					     E TI, T30, T7B, T5i, T7C, T5d, T3b, T1h, T59, T5b, T5e;
					     TI = Tq + TH;
					     T7e = Tq - TH;
