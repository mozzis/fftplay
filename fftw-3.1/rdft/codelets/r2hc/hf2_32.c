...
/* Generated on Fri Jan 27 20:29:51 EST 2006 */
 ...
 * 217 stack variables, and 128 memory accesses
 */
/*
 * Generator Id's : 
...
static const R *hf2_32(R *rio, R *iio, const R *W, stride ios, INT m, INT dist)
{
     ...
     for (i = m - 2; i > 0; i = i - 2, rio = rio + dist, iio = iio - dist, W = W + 8, MAKE_VOLATILE_STRIDE(ios)) {
	  E T9A, T9z;
	  {
	       E T3, T8, T5, T4, T7, T2, TM, Td, T9, TJ, Tb, Tz, T14, T10, T1r;
	       E T1n, TD, Ts, T1w, T1d, T26, Tw, T1z, T23, T19, T2r, T3i, T3P, T2v, T2S;
	       E T3m, T3q, T3L, T2I, T2E, T2W, T3e, Te, TP, T29, T1R, T2b, T1U, Ti, TR;
	       E Tf, T1S, T2f, TV, TQ, Tm, T1Y, T2a, Tg;
	       {
		    E Th, T1T, T1Q, Ta, Tv, Tr;
		    T3 = W[4];
		    T8 = W[1];
		    T5 = W[0];
		    T4 = W[2];
	       ...
	       {
		    E Tq, T46, T8H, T97, TH, T98, T4b, T8D, T7f, TZ, T6t, T4j, T1g, T7g, T6u;
		    E T4q, T4G, T6x, T1J, T7m, T6y, T4z, T7l, T8d, T6B, T4O, T7r, T8e, T4V, T6A;
		    E T2k, T7o, T5s, T6I, T2N, T7A, T55, T6F, T7x, T8i, T5t, T5c, T7D, T8j, T5j;
		    E T5u, T3c, T7y, T5L, T62, T43, T7G, T5S, T63, T7O, T8o, T3G, T7L, T5E, T6M;
		    E T7J, T8n, T6P, T61, T90, T8Z;
		    {
			 E T2F, T31, T1V, T1K, T2T, T2w, T2J, T34, T1N, T2X, T2c, T2s, T2g, T1Z, T3n;
			 E T3f, T3z, T3j, T3C, T3r, T3Q, T3M, T4B, T1m, T1x, T4x, T1H, T1y, T1A, T4D;
			 E T1u;
			 {
			      E T1F, T15, T1s, T11, T1C, TW, TS, T1o, Ty, T48, TG, T4a;
			      {
				   E T1, T8G, Tk, TA, TE, Tn, Tj, To;
				   T1 = rio[0];
				   T8G = iio[-WS(ios, 31)];
				   Tk = rio[WS(ios, 16)];
				   T2F = FNMS(Tg, Td, T2E);
			      ...
			      }
			      {
				   ...
				   {
					E T17, T4m, T1a, T1e, T1b, T4i, T4d;
					{
					     E T12, T16, T13, T4h, TY, T4l, T4g, TU;
					     T12 = rio[WS(ios, 28)];
					     T4g = TW * TT;
					     TU = TS * TT;
					     T16 = iio[-WS(ios, 3)];
					...
					T1b = T19 * T1a;
					{
					     ...
					     }
					     {
						  ...
						  T1x = rio[WS(ios, 10)];
						  T4x = FMA(T1C, T1G, T4w);
						  T1H = FNMS(T1F, T1G, T1E);
						  T4C = T1s * T1p;
						  T1q = T1o * T1p;
						  T1y = T1w * T1x;
						  T1A = iio[-WS(ios, 21)];
						  T4D = FMA(T1o, T1t, T4C);
						  T1u = FNMS(T1s, T1t, T1q);
					     }
					}
				   }
			      }
			 ...
			 {
			      E T2q, T5n, T2A, T2L, T53, T2B, T2C, T5p, T2y;
			      {
				   E T1P, T4Q, T2i, T27, T4M, T24, T4S, T21, T2G, T2K;
				   {
					E T1L, T2d, T4P, T2e, T2h;
					{
					     E T7j, T4t, T1M, T4y, T7k, T1O;
					     {
						  E T4E, T1v, T1I, T4F, T4v, T1B, T4u;
						  T1L = rio[WS(ios, 30)];
						  T1B = FMA(T1z, T1A, T1y);
						  T4u = T1w * T1A;
						  T7j = T4B + T4D;
					...
					}
					{
					     ...
					     T24 = rio[WS(ios, 6)];
					     T4S = FMA(T1V, T20, T4R);
					     T21 = FNMS(T1Z, T20, T1X);
					}
				   }
				   {
					E T2n, T5m, T2o, T2p;
					{
					     E T4T, T7p, T4I, T22, T4K, T28, T4J, T25;
					     T2n = rio[WS(ios, 1)];
					     T4J = T26 * T24;
					     T25 = T23 * T24;
					     T4T = T4Q - T4S;
				   ...
				   }
				   {
					...
					T2C = iio[-WS(ios, 22)];
					T5p = FMA(T2s, T2x, T5o);
					T2y = FNMS(T2w, T2x, T2u);
				   }
			      }
			      {
				   E T3a, T5h, T35, T56, T30, T7B, T5b, T5e, T33;
				   {
					E T2R, T58, T2Z, T5a, T32, T37, T39;
					{
					     E T2Q, T7v, T4Z, T7w, T54, T2P, T57;
					     T2Q = iio[-WS(ios, 26)];
					     {
						  E T2D, T50, T5q, T2z;
						  T2D = FMA(Tb, T2C, T2B);
					     ...
					     T7x = T7v - T7w;
					     T8i = T7v + T7w;
					     T2R = FNMS(T2b, T2Q, T2P);
					     T58 = FMA(T29, T2Q, T57);
					}
					T37 = rio[WS(ios, 13)];
					T39 = iio[-WS(ios, 18)];
					{
					     E T2U, T2Y, T38, T5g, T2V, T59;
					     T2U = rio[WS(ios, 21)];
					     T2Y = iio[-WS(ios, 10)];
					     T38 = T1R * T37;
					     T5g = T1R * T39;
				   ...
				   {
					E T3N, T3K, T3O, T5H, T5Q, T41, T3R, T3U, T3W;
					{
					     E T3H, T3I, T3J, T40, T3Y, T5G, T5P, T3Z;
					     {
						  E T5i, T7C, T5d, T3b, T5f, T36;
						  T3H = rio[WS(ios, 3)];
						  T5f = FMA(T31, T35, T5e);
						  T36 = FNMS(T34, T35, T33);
						  T5t = T5b - T56;
						  T5c = T56 + T5b;
						  T5i = T5f - T5h;
						  T7C = T5f + T5h;
					...
					{
					     E T3l, T5W, T5C, T3E, T3v, T3x, T3t, T5Y, T3w, T5z;
					     {
						  E T3g, T3h, T3k, T3D, T3A, T3s, T3p, T5X;
						  {
		    ...
		    {
			 E T7e, T8T, T7h, T8U, T8s, T8S, T8R, T8v;
			 {
			      E T8p, T8c, T1i, T8A, T8z, T8O, T8J, T8N, T2l, T8m, T8L, T45, T8t, T8l;
			      {
				   E T8k, T8C, T8I, T8h, T3d, T44;
				   {
					E TI, T1h, T8x, T8y;
					T7e = Tq - TH;
					TI = Tq + TH;
			      ...
			      {
				   E T8w, T8u, T8q, T8f, T8K, T8M, T8B, T2m;
				   T8w = T1i - T2l;
				   T2m = T1i + T2l;
				   T8u = T8m + T8p;
				   T8q = T8m - T8p;
			 ...
			 {
			      E T7P, T7K, T7W, T7i, T8a, T86, T82, T91, T8V, T8W, T7t, T81, T7T, T7F, T92;
			      E T7Z;
			      {
				   E T7X, T7n, T7s, T7Y, T84, T85, T7z, T7E;
			      ...
			      }
			      {
				   E T89, T83, T95, T96;
				   {
					E T7S, T7u, T7U, T7Q, T93, T94, T7V, T7R;
		    ...
		    }
		    {
			 ...
			 {
			      E T6c, T4s, T9i, T4X, T9h, T9b, T9c, T6f, T5l, T6h, T6m, T6q, T6a, T66, T5v;
			      {
...
static const R *hf2_32(R *rio, R *iio, const R *W, stride ios, INT m, INT dist)
{
     ...
     INT i;
     for (i = m - 2; i > 0; i = i - 2, rio = rio + dist, iio = iio - dist, W = W + 8, MAKE_VOLATILE_STRIDE(ios)) {
	  E T4, T7, T5, T8, Ta, TM, TO, Tf, T2, Ti, T3, Tc, TD, TH, T1y;
	  E T1H, T15, T1A, T11, T1F, T1n, T1p, T2q, T2I, T2u, T2K, T2V, T3b, T2Z, T3d;
	  E Tu, Ty, T3l, T3n, T1t, T1v, T2f, T2h, T1a, T1e, T32, T34, T1W, T1Y, T2C;
	  E T2E, Th, TR, Tl, TS, Tm, TV, To, TT, T1M, T21, T1P, T22, T1Q, T25;
	  E T1S, T23;
	  {
	       E TB, T13, TF, TZ, TC, T14, TG, T10, Ts, T1c, Tw, T18, Tt, T1d, Tx;
	       E T19;
	       {
		    E T6, Te, T9, Td;
		    T4 = W[2];
